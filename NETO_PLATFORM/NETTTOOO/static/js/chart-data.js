...
$(document).ready(function () {
  ...
  var options = {
    series: [
      { name: "test", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
      { name: "test", data: [76, 85, 101, 98, 87, 105, 91, 114, 94] },
    ],
  ...
  Morris.Donut({
    element: "chart3",
    data: [
      { label: "test", value: 60000, labelColor: "#8944D7" },
      { label: "test", value: 15000, labelColor: "#2FDF84" },
      { label: "test", value: 15000, labelColor: "#00B871" },
      { label: "test", value: 30000, labelColor: "#86B1F2" },
    ],
